...
slug: "mise-replaced-my-entire-dev-setup"
---
...
Mise unifies this mess. For example in my [previous post]({{< relref "posts/2024-05-26-react-native-wsl2-setup-without-android-studio-in-windows.md" >}}) I used wget to get the Android Studio command line tools. Then use it to get the Android SDK. Manually add all the environment variables. Not to forget that Java is assumed to be installed in the env already. With `mise`:
